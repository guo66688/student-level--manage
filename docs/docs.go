        ...
        "/charts/data": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "\"6852592bdc19f14fc8d8957c\"",
                        "description": "图表ID",
                        "name": "id",
                        "in": "query",
                        "required": true
